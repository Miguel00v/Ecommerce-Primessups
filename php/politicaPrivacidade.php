<?php
    ...
    $sql = " SELECT documento FROM documentos_legais WHERE nome = 'Politica de privacidade' ";
...
<head>
    ...
    <title>Primesupps - Política de privacidade</title>
    <meta name="description" content="Leia nossa política de privacidade para saber como coletamos, usamos e protegemos suas informações pessoais no site Primesupps.">
    <meta name="keywords" content="Política de privacidade, Primesupps, informações pessoais, proteção de dados, coleta de dados, uso de informações">
