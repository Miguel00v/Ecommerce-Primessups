...
if (isset($_GET['numero']) && !empty($_GET['numero'])) {
    ...
    if ($resultadoDetalhesEncomenda->num_rows > 0) {
        ...
        while ($detalhe = mysqli_fetch_assoc($resultadoDetalhesEncomenda)) {
            ...
            // Obter o código do cupão e o país de entrega
            ...
            echo "<h1 id='tituloEncomenda'>Número da Encomenda: " . htmlspecialchars($detalhe['numeroEncomenda']) . "</h1>";
        }
        ...
        $totalCompra = $subtotal + $custoEnvio;
