<?php
    ...
    $sql = " SELECT documento FROM documentos_legais WHERE nome = 'Termos e condições' ";
...
<head>
    ...
    <title>Primesupps - Termos e condições</title>
    <meta name="description" content="Leia nossos termos e condições para entender os direitos e obrigações ao usar o site Primesupps.">
    <meta name="keywords" content="termos e condições, política de uso, responsabilidades, site Primesupps, termos legais, política de privacidade">
        ...
        <?php
            ...
            if ($result) {
                ...
                if ($row) {
                    ...
                    echo "<div class='documento'><h1>Termos e condições</h1><p>".$documento."</p></div>";
                } else {
