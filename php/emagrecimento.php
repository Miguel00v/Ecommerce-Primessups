...
<head>
    ...
    <title>Primessups - Emagrecimento</title>
    <meta name="description" content="Encontre os melhores suplementos para emagrecimento na Primessups. Explore opções eficazes e seguras para alcançar seus objetivos de perda de peso e saúde.">
    <meta name="keywords" content="emagrecimento, suplementos para emagrecer, perda de peso, Primessups, saúde, nutrição, suplementos nutricionais">
    ...
    <link rel="stylesheet" href="../css/emagrecimento.css">
</head> 
<body>
...
<main>
    ...
    <div class="backgroundCategorias"><h1>Emagrecimento</h1></div>
